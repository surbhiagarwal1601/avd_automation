...
Set-Logger "C:\WindowsAzure\Logs\Plugins\PackageExecutionLogs\Restart" # inside "packageExecution_$scriptName_$date.log"

# Step 10: Trigger restart
LogInfo("######################")
LogInfo("## Package: Restart ##")
LogInfo("######################")
