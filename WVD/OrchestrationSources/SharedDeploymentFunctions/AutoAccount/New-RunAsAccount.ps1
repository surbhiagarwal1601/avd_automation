function New-RunAsAccount {
    ...
    process {
        ...
        Write-Verbose "== HANDLE CERTIFICATE ==" -Verbose
        ...
        Write-Verbose "Gather cert information" -Verbose
        ...
        if (-not $SelfSignedCertSecret) {
            ...
            Write-Verbose ("Cert secret '{0}' found in key vault '{1}'." -f $SelfSignedCertSecretName, $KeyVaultName) -Verbose
        ...
        Write-Verbose "Create the Automation certificate asset" -Verbose
        ...
        Write-Verbose "=======================" -Verbose
        Write-Verbose "== SET RUNAS ACCOUNT ==" -Verbose
