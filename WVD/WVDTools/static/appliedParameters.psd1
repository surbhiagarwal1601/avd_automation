@{
	...
	ImagingRGName                               = '<ReplaceWith-WVD-Imaging-RG>'
	MgmtRGName                                  = '<ReplaceWith-WVD-Mgmt-RG>'
	ProfilesRGName                              = '<ReplaceWith-WVD-AzProfiles-RG>'
	...
	ImageContainerName							= '<ReplaceWith-ImageContainerName>'
